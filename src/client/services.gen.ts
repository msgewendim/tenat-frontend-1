 ...
 */
export const postOrdersGenerateSale = <ThrowOnError extends boolean = false>(options: Options<PostOrdersGenerateSaleData, ThrowOnError>) => { return (options?.client ?? client).post<PostOrdersGenerateSaleResponse, PostOrdersGenerateSaleError, ThrowOnError>({
    ...options,
    url: '/orders/generate-sale'
}); };

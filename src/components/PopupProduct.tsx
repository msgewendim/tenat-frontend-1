  ...
  return (
    <Dialog open={open} onClose={setOpen} className="relative z-10">
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex sm:min-h-full h-[55vh] justify-center p-4 text-center sm:items-center sm:p-0">
          <DialogPanel
            transition
            className="relative 
              transform 
          ...
          >
            <div className="bg-white pb-4 sm:p-6 sm:pb-0 sm:my-4 relative min-h-[280px]">
              <div className="sm:grid flex flex-col justify-end sm:grid-cols-2 sm:text-end sm:items-start w-full">
                ...
                <div className="pb-2 sm:px-2 sm:pb-4">
                  {images && <img src={images[0]} alt={name} className="sm:rounded-xl object-cover sm:object-cover sm:h-[280px] max-h-[240px]" />}
                </div>
                {/* content */}

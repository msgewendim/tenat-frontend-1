    ...
    <form id="form" className="w-[80vw] h-20 flex justify-between items-center bg-slate-200 rounded-lg px-14">
      ...
      <fieldset className="space-y-1 dark:text-gray-800 px-1">
        ...
        <div dir="rtl" className="relative">
          <input
            type="search" name="search" id="searchProductsInput" onChange={(e) => handleSearch(e)} placeholder="הקלד שם מוצר" className="w-32 py-2 pr-6 placeholder:absolute placeholder:right-6 text-sm rounded-md sm:w-auto focus:outline-none dark:bg-gray-100 dark:text-gray-800 focus:dark:bg-gray-50 focus:dark:border-violet-600" />
